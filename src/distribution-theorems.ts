...
const ref = (path: string, label: string) => ({
  url: `https://www.randomservices.org/random/${path}.html`,
  label: `Random: ${label}`,
});
const result = (
  id: string,
...
const refs = {
  normal: ref('special/Normal', 'Normal distribution'),
  uniform: ref(
    'special/UniformContinuous',
    'Uniform distribution on an interval',
  ),
  exponential: ref('poisson/Exponential', 'Exponential distribution'),
  binomial: ref('bernoulli/Binomial', 'Binomial distribution'),
  poisson: ref('poisson/Poisson', 'Poisson distribution'),
  bernoulli: ref('bernoulli/Introduction', 'Bernoulli trials'),
  geometric: ref('bernoulli/Geometric', 'Geometric distribution'),
  negative_binomial: ref(
    'bernoulli/NegativeBinomial',
    'Negative binomial distribution',
  ),
  discrete_uniform: ref(
    'special/UniformDiscrete',
    'Discrete uniform distributions',
  ),
  lognormal: ref('special/LogNormal', 'Lognormal distribution'),
  laplace: ref('special/Laplace', 'Laplace distribution'),
  logistic: ref('special/Logistic', 'Logistic distribution'),
  cauchy: ref('special/Cauchy', 'Cauchy distribution'),
  weibull: ref('special/Weibull', 'Weibull distribution'),
  rayleigh: ref('special/Rayleigh', 'Rayleigh distribution'),
  pareto: ref('special/Pareto', 'Pareto distribution'),
  triangular: ref('special/Triangle', 'Triangle distribution'),
};
export const distributionTheorems: Record<string, Theorem[]> = {
  normal: [
    result(
      'central-limit',
      'Central limit theorem',
      'Limit theorem',
      'X₁, X₂, … are independent and identically distributed, with mean μ and finite variance σ² > 0. X̄ₙ is their sample mean.',
      ...
      'For the centred, standardised variable, the characteristic function has expansion 1 − t²/2 + o(t²). Independence makes the normalised sum’s characteristic function its nth power at t/√n, tending to exp(−t²/2). This is a limiting result, not an exact finite-sample identity.',
      ref('sample/CLT', 'Central limit theorem'),
      ['bernoulli', 'binomial'],
    ),
    result(
      'normal-sums',
  ...
  exponential: [
    ...
    result(
      'exponential-minimum',
      'Minimum of independent waiting times',
      'Closure theorem',
  ...
  binomial: [
    ...
    result(
      ...
      'Poisson limit of rare events',
      'Limit theorem',
      'Xₙ ∼ Bin(n, pₙ), with n → ∞ and npₙ → λ > 0.',
      'For each fixed integer k ≥ 0, P(Xₙ = k) → exp(−λ) λᵏ / k!.',
  ...
  poisson: [
    result(
      'poisson-sum',
      'Superposition of independent counts',
      'Closure theorem',
  ...
  geometric: [
    ...
    result(
      ...
      refs.geometric,
      ['negative_binomial', 'bernoulli'],
    ),
  ],
  negative_binomial: [
    result(
      'negative-binomial-sum',
      'Adding failure counts',
      'Closure theorem',
      ...
      refs.negative_binomial,
      ['geometric'],
    ),
    result(
      'negative-binomial-tail',
      'Connection to binomial counts',
      'Tail identity',
  ...
  discrete_uniform: [
    result(
      'discrete-uniform-transform',
      'Uniform integers from a uniform draw',
      'Transformation',
      ...
      refs.discrete_uniform,
      ['uniform'],
    ),
    result(
      'discrete-uniform-variance',
      'Variance of consecutive uniform integers',
      'Moment identity',
  ...
  lognormal: [
    ...
    result(
      'lognormal-products',
      'Products of independent lognormal variables',
      'Closure theorem',
  ...
  laplace: [
    result(
      'laplace-difference',
      'Difference of exponential variables',
      'Representation theorem',
    ...
    result(
      'laplace-absolute',
      'Absolute deviation is exponential',
      'Transformation',
      'X ∼ Laplace(μ, s), s > 0.',
      '|X − μ| ∼ Exp(1/s).',
  ...
  logistic: [
    result(
      'logistic-logit',
      'Logit of a uniform variable',
      'Transformation',
      'U ∼ U(0, 1), real μ, scale s > 0. The logarithm uses 0 < U < 1.',
      'μ + s ln(U/(1 − U)) ∼ Logistic(μ, s).',
  ...
  cauchy: [
    result(
      'cauchy-ratio',
      'Ratio of independent standard normals',
      'Representation theorem',
    ...
    result(
      'cauchy-mean',
      'The Cauchy expectation does not exist',
      'Moment result',
      'X ∼ Cauchy(x₀, s), s > 0.',
      'E[X] is undefined; a finite variance does not exist.',
  ...
  weibull: [
    result(
      'weibull-exponential',
      'Power transform to an exponential',
      'Transformation',
    ...
    result(
      'weibull-hazard',
      'Shape controls the hazard rate',
      'Hazard identity',
  ...
  rayleigh: [
    ...
    result(
      'rayleigh-square',
      'Squared radius and the exponential',
      'Transformation',
      'R ∼ Rayleigh(σ), σ > 0.',
      'R²/(2σ²) ∼ Exp(1); R ∼ Weibull(2, σ√2).',
  ...
  pareto: [
    result(
      'pareto-log',
      'Logarithm of a Pareto variable',
      'Transformation',
  ...
  triangular: [
    ...
    result(
      'triangular-affine',
      'Affine transformations preserve triangular shape',
      'Closure theorem',
      'X ∼ Tri(a, c, b), a < b, a ≤ c ≤ b. Real d and multiplier h > 0.',
      'd + hX ∼ Tri(d + ha, d + hc, d + hb).',
